...
function LogoRow({
  ...
  // playOnInit (the AutoScroll default) plus stopOnInteraction/MouseEnter/
  // FocusIn all disabled below means this never pauses once mounted — it
  // stays live for the lifetime of the component, on-screen or not.
