 ...
 * the right — first question expanded by default. Data is fetched
 * server-side (app/faqs/page.tsx) from Supabase and passed in as props.
 */
export function FaqAccordion({ faqs }: { faqs: FaqRow[] }) {
