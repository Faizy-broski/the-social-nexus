...
import { WebBriefForm } from "@/components/web-brief/web-brief-form";
import NetworkLines from "@/components/contact/network-lines";

export const metadata: Metadata = {
  title: "Web Brief / Business Information | The Social Nexus",
  description:
    "Share your business and website details with The Social Nexus so we can start building your project the right way.",
};
      ...
      <div className="container-section relative py-14 sm:py-20 lg:py-28">
        <div className="scroll-reveal-row mx-auto mb-10 max-w-2xl text-center sm:mb-14 lg:mb-16">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
            <span className="gradient-text-animated">Business Information</span>
          </h1>
          <p className="mt-4 text-sm text-white/70 sm:text-base">
            The more detail you share, the faster our team can design and
            build a website that fits your business. Fields marked with * are
            required.
          </p>
        </div>
