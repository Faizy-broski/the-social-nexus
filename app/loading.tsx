 ...
 * loading.tsx
 * ------------------------------------------------------------------
 * Next.js shows this automatically during route transitions and
 * Suspense boundaries — it needs to be cheap and fast, so this stays
 * a Server Component with pure CSS animation (no GSAP, no client JS)
 * exactly like the `.scroll-reveal-row` approach used elsewhere.
 *
