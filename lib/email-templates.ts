      ...
      (row) => `
        <tr>
          <td style="padding: 14px 0; border-bottom: 1px solid ${BORDER};">
            <p style="margin: 0 0 4px; font: 700 11px/1.4 -apple-system, Segoe UI, Roboto, sans-serif; letter-spacing: 0.06em; text-transform: uppercase; color: ${BRAND_TEAL_DARK};">
...
<!doctype html>
<html>
  <body style="margin: 0; padding: 32px 16px; background: #F4F6F8; font-family: -apple-system, Segoe UI, Roboto, sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background: #FFFFFF; border-radius: 12px; overflow: hidden; border: 1px solid ${BORDER};">
      <tr>
        <td style="background: ${BRAND_NAVY}; padding: 28px 32px;">
          <p style="margin: 0; font: 800 13px/1 -apple-system, Segoe UI, Roboto, sans-serif; letter-spacing: 0.18em; text-transform: uppercase; color: #FFFFFF;">
            The Social Nexus
          </p>
          <div style="margin-top: 14px; height: 3px; width: 48px; background: linear-gradient(90deg, ${BRAND_TEAL}, ${BRAND_GOLD});"></div>
        </td>
      </tr>
      <tr>
        <td style="padding: 32px;">
          <p style="margin: 0 0 6px; font: 700 12px/1 -apple-system, Segoe UI, Roboto, sans-serif; letter-spacing: 0.08em; text-transform: uppercase; color: ${BRAND_GOLD};">
            ${escapeHtml(eyebrow)}
          </p>
          <h1 style="margin: 0 0 12px; font: 800 22px/1.3 -apple-system, Segoe UI, Roboto, sans-serif; color: ${BRAND_NAVY};">
            ${escapeHtml(heading)}
          </h1>
      ...
      <tr>
        <td style="padding: 20px 32px; background: #FAFBFC; border-top: 1px solid ${BORDER};">
          <p style="margin: 0; font: 400 12px/1.6 -apple-system, Segoe UI, Roboto, sans-serif; color: ${TEXT_MUTED};">
            ...
            <a href="https://thesocialnexus.co.uk" style="color: ${BRAND_TEAL_DARK}; text-decoration: none;">thesocialnexus.co.uk</a>
            &middot; ${new Date().toLocaleString("en-GB", { dateStyle: "medium", timeStyle: "short" })}
          </p>
        </td>
      </tr>
    </table>
